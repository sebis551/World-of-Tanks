    ...
    class Cameraa
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newVector2 = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(up, 1);
            up = glm::normalize(glm::vec3(newVector2));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newVector = glm::rotate(glm::mat4(1.0f), RADIANS(angle), glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(newVector));
            glm::vec4 newVector2 = glm::rotate(glm::mat4(1.0f), RADIANS(angle), glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newVector2 = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newVector2));
